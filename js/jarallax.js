...
const exampleEmbed = new EmbedBuilder()
	.setColor(0x0099FF)
	.setTitle('Poly Racing')
	.setURL('https://polyracing.xyz')
	.setDescription("Welcome to PolyRacing! Get ready to experience the thrill of high-speed racing like never before. Our game features stunning graphics and animations, with a unique poly style that sets it apart from other racing games. You'll feel like you're racing through a futuristic world filled with bright colors and sharp angles.")
//	.setThumbnail('https://media.discordapp.net/attachments/1101321551862845600/1105479816867741706/AUAvIonqlvmiAAAAAElFTkSuQmCC.png?width=758&height=300')
	.addFields({ name: 'Support and Community', value: 'https://discord.gg/polyracing', inline: true })
	.setImage('https://media.discordapp.net/attachments/1101321551862845600/1105479816867741706/AUAvIonqlvmiAAAAAElFTkSuQmCC.png?width=758&height=300')
